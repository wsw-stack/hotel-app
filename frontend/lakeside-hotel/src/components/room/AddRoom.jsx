                ...
                <div className='col-md-8 col-lg-6'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='mb-3'>
                            ...
                            <input className='form-control' type="number" id="roomPrice" value={newRoom.roomPrice} onChange={handleRoomInputChange} required/>
                        </div>
                        <div className='mb-3'>
                            <label htmlFor='photo' className='form-label'>Room Photo</label>
                            <input className='form-control' type="file" id="photo" onChange={handleImageChange} required/>
                        </div>
                        {imagePreview && (
